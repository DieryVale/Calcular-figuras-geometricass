// para Minificar el codigo; https://www.toptal.com/developers/javascript-minifier
// el anterior link pone todo el codigo en una sola linea de codigo y lo minimiza
...
const myModule = (() =>
{
    ...
    */ 
     ...
     btnAreaSquare.addEventListener('click',()=>
    {
        ...
        const result = `El àrea del cuadrado es: ${areaSquare(value)} cm^2`
